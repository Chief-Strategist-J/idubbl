...
export default function PrizeBreakdown({ entryFee, rake, prize, isWinner }) {
  ...
  return (
    <div style={{ background: 'var(--glass-bg)', borderRadius: 12, padding: '1.25rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
        {[
          ...
          { label: 'Platform fee', value: `-${rake} USDT`, color: 'var(--accent-red)' },
        ...
        <div style={{ borderTop: '1px solid var(--border)', marginTop: '0.5rem', paddingTop: '0.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.25rem', color: isWinner ? 'var(--accent-green)' : 'var(--accent-red)' }}>
