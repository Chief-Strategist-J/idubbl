          ...
          {sent ? (
            <div style={{ textAlign: 'center', padding: '1rem 0' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '1.5rem', lineHeight: 1.5 }}>
                ...
                Please check your spam/junk folder if you do not receive it shortly.
              </p>
              <Link to="/login" style={{ color: 'var(--primary)', fontSize: '0.9rem', fontWeight: 'bold' }}>Back to login</Link>
            </div>
          ) : (
            <>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', marginBottom: '0.5rem' }}>Forgot password?</h2>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '2rem' }}>
                Enter the email on your account and we will send you a temporary password to log in.
              </p>
              <form onSubmit={handleSubmit}>
                ...
                <Button type="submit" loading={loading} fullWidth>Send temporary password</Button>
              </form>
